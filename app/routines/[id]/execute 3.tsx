  ...
  useEffect(() => {
    if (isComplete && !animationFinished) {
      const fallbackTimer = setTimeout(() => {
        console.log('[Routine Complete] Animation fallback timer triggered');
        setAnimationFinished(true);
      }, 3000); // 3 second fallback (animation is 2 seconds at 30fps/60frames)
    ...
    return (
      <View style={styles.completeContainer}>
        ...
        <LottieView
          ...
          onAnimationFinish={() => {
            console.log('[Routine Complete] Animation finished callback');
            setAnimationFinished(true);
          }}
        />
        ...
        {/* Done Button - enabled after animation finishes (or fallback timer) */}
        <TouchableOpacity
          style={[
            styles.doneButton,
            !animationFinished && styles.doneButtonLoading,
          ]}
